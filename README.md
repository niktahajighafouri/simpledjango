...
# به کمک دیتور زیر میتوانید دایکیومنت گراف کیو ال رو مجدد تولید کنید و باید تغییراتی در صفحه اچ تی ام ال و جا به جایی فولدر های جاوااسکریپت و سی اس اس در پوشه استاتیک و ایندکس در پوشه تمپلیت میتوانید در یو آر ال 
-docs/graphql/
